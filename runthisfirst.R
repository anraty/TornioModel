...
PathData_FLHM<-paste0(pathMain,"WGBAST_shared/data/data_2023/") # Assessment model data files
PathModel_FLHM<-paste0(pathMain,"Rprojects/WGBAST/03-flhm/") 
PathOut_FLHM<-paste0(pathMain,"WGBAST_shared/flhm/2023/output/")
...
PathFiles<-paste0(pathMain,"Rprojects/WGBAST/04-scenarios/") # Relative path, this should not be needed
